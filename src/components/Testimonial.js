      ...
      <div className="testimonial">
        ...
        <div className="testimonial_content">
          ...
          <div className="photoGallery">
            <Photo image="https://i.pravatar.cc/48/1" />
            <Photo image="https://i.pravatar.cc/48/2" />
            <Photo image="https://i.pravatar.cc/48/3" />
            <Photo image="https://i.pravatar.cc/48/4" />
            <Photo image="https://i.pravatar.cc/48/5" />
          </div>
        </div>
      </div>
    </>

  ...
  return (
    <div className="features">
      ...
      <div className="features_data">
        <p>FEATURES</p>
        <h1>Uifry Premium</h1>
        <ul className="features_content">
          <li>
            <Paragraph
              title="budgeting intervals"
              paragraph="Cum et convallis risus placerat aliquam, nunc. Scelerisque aliquet faucibus tincidunt eu adipiscing sociis arcu lorem porttitor."
            >
              <svg
                width="24"
                height="24"
